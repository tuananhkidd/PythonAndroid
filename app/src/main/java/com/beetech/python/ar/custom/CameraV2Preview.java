...
import com.beetech.python.ar.util.DisplayUtils;

import java.util.List;

public class CameraV2Preview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public CameraV2Preview(Context context, CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context);
        init(cameraWrapper, previewCallback);
    }

    public CameraV2Preview(Context context, AttributeSet attrs, CameraWrapper cameraWrapper, Camera.PreviewCallback previewCallback) {
        super(context, attrs);
        init(cameraWrapper, previewCallback);
    }
